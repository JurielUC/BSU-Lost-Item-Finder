...
<html lang="en">
    <head>
        ...
        <title>BSU Lost-Item Finder | Archives</title>
        ...
        <main>
            ...
            <div class="output-container">
                <?php
                                    ...
                                    $result=mysql_query("SELECT * FROM tb_deletedmsg INNER JOIN tb_accounts ON tb_deletedmsg.dmsrcode = tb_accounts.srcode ORDER BY dmid DESC") or die("Error");
                                    ...
                                    <div class='output-cont-table'>
                                        <table style="width:100%">
                                            <tr>
                                                ...
                                                <th style="text-align: right; background-color: #cccccc"><a style="color:#990000; margin: 10px;" href='delete_archives.php?id="<?php echo $row['dmid']; ?>"'>Delete</a>
                                                <a style="color:#990000; margin: 10px;" name="move" onClick="retrieveMsg()" href='move_to_message_from_archive.php?id="<?php echo $row['dmid']; ?>"'>Retrieve</a>
                                                </th>
                                            </tr>
                                            <tr>

    ...
    <body>
        ...
        <main>
            ...
            <?php
                ...
                $campus=$_GET['campus'];
                $sql="SELECT * FROM 'tb_accounts' WHERE srcode=$srcode, fullname=$fullname, contactno=$contactno, email=$email, password=$password, program=$program, department=$department, campus=$campus";
            ...
            ?>
                ...
                <form class='form' action="Update_account.php" method="POST" enctype="multipart/form-data">
                        <div class="first-three">
                            <input class="input big" type="text" placeholder="Fullname..." name="fullname" value='<?php echo $fullname;?>' required>
                            <input class="input small" type="text" placeholder="Sr-code" name="srcode" value='<?php echo $srcode;?>'>
                            <input class="input small" type="text" placeholder="Contactno..." name="contactno" value='<?php echo $contactno;?>'>
                        </div>
                        <div class="second-three">
                            ...
                            <input class="input small" type="text" placeholder="Program..." name="program" value='<?php echo $program;?>' required>
                        </div>
